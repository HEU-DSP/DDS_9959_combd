...
void HAL_LPTIM_MspInit(LPTIM_HandleTypeDef* hlptim)
{
  ...
  */
    ...
    PA1     ------> LPTIM3_OUT
    */
    GPIO_InitStruct.Pin = LPTIM3_SPIDMA_SYNC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_LPTIM3;
    HAL_GPIO_Init(LPTIM3_SPIDMA_SYNC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef* hlptim)
{
  if(hlptim->Instance==LPTIM3)
  {
    ...
    PA1     ------> LPTIM3_OUT
    */
    HAL_GPIO_DeInit(LPTIM3_SPIDMA_SYNC_GPIO_Port, LPTIM3_SPIDMA_SYNC_Pin);
...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef* hospi)
{
  if(hospi->Instance==OCTOSPI1)
  {
    ...
    PD13     ------> OCTOSPIM_P1_IO3
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_13);
...
void HAL_OPAMP_MspInit(OPAMP_HandleTypeDef* hopamp)
{
  ...
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PB0     ------> OPAMP1_VINP
    */
    GPIO_InitStruct.Pin = ANALOG_EXT_O1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ANALOG_EXT_O1_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ANALOG_EXT_1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ANALOG_EXT_1_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PE9     ------> OPAMP2_VINP
    */
    GPIO_InitStruct.Pin = ANALOG_EXT_O2_Pin|ANALOG_EXT_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PB0     ------> OPAMP1_VINP
    */
    HAL_GPIO_DeInit(ANALOG_EXT_O1_GPIO_Port, ANALOG_EXT_O1_Pin);

    HAL_GPIO_DeInit(ANALOG_EXT_1_GPIO_Port, ANALOG_EXT_1_Pin);
  ...
  else if(hopamp->Instance==OPAMP2)
  {
    ...
    PE9     ------> OPAMP2_VINP
    */
    HAL_GPIO_DeInit(GPIOE, ANALOG_EXT_O2_Pin|ANALOG_EXT_2_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pin = SPI_9959_SCLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    HAL_GPIO_Init(SPI_9959_SCLK_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = SPI_9959_IO2_R_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLDOWN;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI1;
    HAL_GPIO_Init(SPI_9959_IO2_R_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PB4(NJTRST)     ------> SPI1_MISO
    */
    HAL_GPIO_DeInit(SPI_9959_CS_GPIO_Port, SPI_9959_CS_Pin);

    HAL_GPIO_DeInit(SPI_9959_DIO0_GPIO_Port, SPI_9959_DIO0_Pin);

    HAL_GPIO_DeInit(GPIOB, SPI_9959_SCLK_Pin|SPI_9959_IO2_R_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  if(htim_base->Instance==TIM4)
  {
    ...
    */
    ...
    GPIO_InitStruct.Pin = ETR_SPIDMA_SYNC_4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(ETR_SPIDMA_SYNC_4_GPIO_Port, &GPIO_InitStruct);

    /* TIM4 DMA Init */
    /* TIM4_UP Init */
    hdma_tim4_up.Instance = DMA1_Stream3;
  ...
  else if(htim_base->Instance==TIM8)
  {
    ...
    PA0     ------> TIM8_ETR
    */
    GPIO_InitStruct.Pin = ETR_SPIDMA_SYNC_8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
    HAL_GPIO_Init(ETR_SPIDMA_SYNC_8_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM8)
  {
    ...
    PC7     ------> TIM8_CH2
    */
    GPIO_InitStruct.Pin = SYNC_9959_IO_UPDATE_Pin|SPI_9959_DIO3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
  ...
  else if(htim->Instance==TIM15)
  {
    ...
    PC12     ------> TIM15_CH1
    */
    GPIO_InitStruct.Pin = REF_9959_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM15;
    HAL_GPIO_Init(REF_9959_CLK_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  if(htim_base->Instance==TIM4)
  {
    ...
    PE0     ------> TIM4_ETR
    */
    HAL_GPIO_DeInit(GPIOB, SPI_9959_CS_CAPTURE1_Pin|SPI_9959_CS_CAPTURE2_Pin);

    HAL_GPIO_DeInit(ETR_SPIDMA_SYNC_4_GPIO_Port, ETR_SPIDMA_SYNC_4_Pin);
  ...
  else if(htim_base->Instance==TIM8)
  {
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(ETR_SPIDMA_SYNC_8_GPIO_Port, ETR_SPIDMA_SYNC_8_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  if(huart->Instance==UART4)
  {
    ...
    PD1     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = IO_9959_3_Pin|IO_9959_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART4)
  {
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, IO_9959_3_Pin|IO_9959_2_Pin);
